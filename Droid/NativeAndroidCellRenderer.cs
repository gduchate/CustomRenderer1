...
namespace CustomRenderer.Droid
{
	...
	public class NativeAndroidCellRenderer : ViewCellRenderer
	{
		protected override Android.Views.View GetCellCore (Xamarin.Forms.Cell item, Android.Views.View convertView, ViewGroup parent, Context context)
		{
			...
			view.FindViewById<TextView> (Resource.Id.HostName).Text = x.HostName;
			view.FindViewById<TextView> (Resource.Id.OSName).Text = x.OSName;
            view.FindViewById<TextView>(Resource.Id.OnlineSince).Text = x.OnlineSince;
            view.FindViewById<TextView>(Resource.Id.IPaddress).Text = x.IPAddress;
